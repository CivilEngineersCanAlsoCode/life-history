# Sub-Requirement: 12.8.8

**Parent Capability:** [Sandbox - Simulation functionality](12.8_Capability.md)

## Description
The system must have capability to allow a simulation exercise to be cancelled at any point. The user will be required to confirm the cancellation.


## Discovery Questions
- [ ] When cancelled, are partial results saved or discarded entirely?
- [ ] Can a cancelled run be 'Retried' from the failure point?
