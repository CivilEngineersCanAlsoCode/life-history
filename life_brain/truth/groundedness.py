...
from life_brain.truth.conflict_detector import ConflictDetector, ConflictResult
...
from life_brain.truth.hallucination_prevention import HallucinationPrevention, ValidationResult
